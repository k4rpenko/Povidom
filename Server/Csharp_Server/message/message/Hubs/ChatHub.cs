...
namespace message.Hubs
{
    public class ChatHub : Hub, IChatHub
    {
        ...
        public ChatHub(AppMongoContext _Mongo, IConfiguration _configuration, IJwt jwt, AppDbContext _context, UsersConnectMessage UCM)
        {
        ...
        public async Task<bool> Connect(string token)
        {
            try
            {
                var id = _jwt.GetUserIdFromToken(token);
